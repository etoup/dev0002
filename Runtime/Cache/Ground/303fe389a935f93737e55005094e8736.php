        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="/Public/Ground/images/logo.jpg" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="<?php echo U('Setting/index');?>"><i class="fa fa-circle-o text-red"></i> <span>基础设置</span></a></li>
                <li><a href="<?php echo U('Setting/items');?>"><i class="fa fa-circle-o text-yellow"></i> <span>项目设置</span></a></li>
                <li><a href="<?php echo U('Setting/block');?>"><i class="fa fa-circle-o text-aqua"></i> <span>场地设置</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="<?php echo U('index');?>">锁定列表</a></li>
                            ...
                            <div class="box-body">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                            ...
                                            <td>
                                                <?php switch($vo["status"]): case "1": ?>锁定<?php break;?>
                                                    <?php case "-1": ?>解锁<?php break;?>
