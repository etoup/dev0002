        ...
        <div class="col-md-9">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?php echo U('reserve');?>">预订管理</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="reserve">
                        <div class="alert alert-warning alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                            <h4><i class="icon fa fa-warning"></i> 提示</h4>
                            批量预定可以根据运营需要，按照项目、场地、日期段、星期、时间段进行精确预定
                        </div>
                        <form action="/play.php?s=/Index/reserve.html" method="post" id="form_reserve">
                            <div class="box box-default">
                                <div class="box-header with-border">
                                    <h3 class="box-title">批量预定</h3>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>支付方式 </label>
                                                <select class="form-control select2" name="paytypes" style="width: 100%;">
                                                    <option value="" selected>请选择</option>
                                                    <?php if(is_array($paytypes)): foreach($paytypes as $key=>$vo): ?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
                                                </select>
                                            </div><!-- /.form-group -->
                                        </div><!-- /.col -->
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>是否付款 </label>
                                                <select class="form-control select2" name="paystatus" style="width: 100%;">
                                                    <option value="" selected>请选择</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>付款金额 </label>
                                                <input type="text" name="money" class="form-control" id="money" placeholder="填写付款金额">
                                            </div><!-- /.form-group -->
                                        </div><!-- /.col -->
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>预定手机 </label>
                                                <input type="text" name="mobile" class="form-control" id="mobile" placeholder="填写预定的手机号码">
                                            </div><!-- /.form-group -->
                                        </div><!-- /.col -->
                                    </div>
                                </div>
                                <div class="box-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right" id="submit_reserve">立即预定</button>
                                    <style>
                                        form label.error{
                                            color: #dd4b39;
                                            margin-bottom: 0;
                            ...
                            <div class="box-body">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                            ...
                                            <td>
                                                <?php if(is_array($paytypes)): foreach($paytypes as $key=>$v): if($key == $vo['paytypes']): echo ($v); endif; endforeach; endif; ?>
                                            </td>
                                            <td>
                                                <?php switch($vo["paystatus"]): case "1": ?>已支付<?php break;?>
                                                    <?php case "0": ?>未支付<?php break; endswitch;?>
                                            </td>
                                            <td><?php echo (money($vo["money"])); ?></td>
