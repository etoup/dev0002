            ...
            <div class="nav-tabs-custom">
                ...
                <div class="active tab-pane" id="activity">
                    ...
                    <div class="box box-default">
                        <form action="/play.php?s=/Locks/index.html" method="post">
                            ...
                            <div class="box-footer">
                                ...
                                <?php if($soso): ?><a class="btn btn-warning pull-right" href="<?php echo U('index');?>" style="margin-left: 10px">撤销检索</a><?php endif; ?>
