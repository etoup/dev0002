...
<html>
    <head>
        ...
        <link href="/Public/Admin/css/admin_layout.css" rel="stylesheet" />
        <style>
    ...
    <body>
        <div class="wrap">
            ...
            <table width="100%" height="100%" style="table-layout:fixed;">
                <tr class="head">
                    <th><a href="<?php echo U('Admin/Index/index');?>" class="logo">管理中心</a></th>
                    <td>
                    <div class="nav">
                    ...
                    <div class="login_info">
                        <a href="<?php echo ROOT;?>" class="home" target="_blank">前台首页</a><span class="mr10">管理员： <?php echo USERNAME;?></span><a href="<?php echo U('Public/logout');?>" class="mr10">[注销]</a>
                    </div></td>
                </tr>
                <tr class="tab">
                    <th>
                    <div class="search">
                        <input size="15" placeholder="Hi，BOBOOKING！" id="J_search_keyword" type="text">
                ...
                <tr class="content">
                    ...
                    <td id="B_frame">
                        ...
                        <iframe id="iframe_default" src="<?php echo U('Home/index');?>" style="height: 100%; width: 100%;display:none;" data-id="default" frameborder="0" scrolling="auto"></iframe>
                    </td>
                </tr>
            </table>
        </div>
...
var USUALL = [], /*常用的功能模块*/
    ...
    SUBMENU_CONFIG = <?php echo ($__MENU__); ?>,/*主菜单区*/
    imgpath = '',
    times = 0,
    getdescurl = '',
    searchurl = '',
