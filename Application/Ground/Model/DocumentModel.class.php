...
class DocumentModel extends Model {
	...
	protected $_validate = array(
		...
		array('category_id', 'checkCategory', '该分类不允许发布内容', self::EXISTS_VALIDATE, 'function', self::MODEL_UPDATE),
		array('category_id,type', 'checkCategory', '内容类型不正确', self::MUST_VALIDATE, 'function', self::MODEL_INSERT),
		array('model_id,pid,category_id', 'checkModel', '该分类没有绑定当前模型', self::MUST_VALIDATE, 'function', self::MODEL_INSERT),
	);
	...
	public function autoSave() {
		...
		$this->_validate = array(
			...
			array('category_id', 'checkCategory', '该分类不允许发布内容', self::EXISTS_VALIDATE, 'function', self::MODEL_UPDATE),
			array('category_id,type', 'checkCategory', '内容类型不正确', self::MUST_VALIDATE, 'function', self::MODEL_INSERT),
			array('model_id,pid,category_id', 'check_Model', '该分类没有绑定当前模型', self::MUST_VALIDATE, 'function', self::MODEL_INSERT),
