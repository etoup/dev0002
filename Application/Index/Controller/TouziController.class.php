...
class TouziController extends HomeController {
    ...
    private function _get_crumbs() {
        return ['url' => U('Index/index'), 'title' => '首页'];
    }
