...
class PeiziController extends HomeController {
            ...
            switch($from){
                ...
                case 'peizi':
                    ...
                    if (!UID) {
                        ...
                        switch($mobile){
                            case 'weixin':
                                $backUrl = U('doNeeds',['mobile'=>'weixin'],false);
                                break;
                            default:
                                $backUrl = 'doNeeds';
                        }
