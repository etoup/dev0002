		...
		switch(true){
			...
			case _config.align == 'top':
				...
				$('.js-max-input',elemParent).css({'position':'absolute','top' :-elemHeight - containerHeight/2,'left':0})
                    .css({'padding':'8px 15px', 'font-size': '20px', 'width':'100%', 'background': '#ff9900', 'color': '#ffffff', 'font-style': 'italic', 'border-radius':'4px'});
				break;
			...
			case _config.align == 'bottom':
				...
				$('.js-max-input',elemParent).css({'position':'absolute', 'top' :elemHeight + 4 + 'px', 'left':0, 'z-index':1})
                    .css({'padding':'8px 15px', 'font-size': '20px', 'width':'100%', 'background': '#ff9900', 'color': '#ffffff', 'font-style': 'italic', 'border-radius':'4px'});
				break;
