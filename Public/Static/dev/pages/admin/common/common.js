/*
 * etoup PAGE JS
 * @Copyright Copyright 2011, etoup.com
...
;(function() {
	...
	if( $('a.J_dialog').length ) {
		Wind.use('dialog',function() {
			$('.J_dialog').live( 'click',function(e) {
				e.preventDefault();
				var _this = $(this);
	...
	$('.yesno').dblclick(function(){
		if($(this).hasClass('notoyes')){
			$(this).removeClass('notoyes').next('input').val(1);
		}else{
			$(this).addClass('notoyes').next('input').val(0);
		}
    });
