...
(function(win) {
	var root = win.GV.JS_ROOT || location.origin + '/js/dev/', //在wind.js加载之前定义GV.JS_ROOT
		...
		alias = {
            ...
            ucenter             : 'pages/ucenter/common/common',
            ucfoot             : 'pages/ucenter/common/ucfoot',
            jquery             : 'jquery',
            xd                    : 'xd',
            ...
            zTree              : 'ui_libs/zTree/zTree',
            artDialog          : 'ui_libs/artDialog/artDialog',
            iframeTools        : 'ui_libs/artDialog/iframeTools',
            swfupload          : 'ui_libs/swfupload/swfupload',
		...
		alias_css = {
			...
			chosen		: 'ui_libs/chosen/chosen',
            zTree       : 'ui_libs/zTree/zTreeStyle/zTreeStyle',
            artDialog   : 'ui_libs/artDialog/skins/default'
		};
